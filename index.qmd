...
Este libro corresponde al repositorio de recodificación de la base de datos de la **Encuesta CONCLAT** para Chile y Argentina, para ser incluído como capítulos de libro.

En el [primer capítulo](01-recodificaciones-conclat-cl.html) se encuentra la recodificación para Chile, y en el [segundo capítulo](02-recodificaciones-conclat-ar.html) se encuentra la recodificación para Argentina. 
